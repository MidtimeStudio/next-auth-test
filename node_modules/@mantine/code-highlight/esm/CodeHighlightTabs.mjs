...
const CodeHighlightTabs = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { ...getStyles("root"), mod: { collapsed: !_expanded }, ref, ...others, dir: "ltr" }, withHeader && /* @__PURE__ */ React.createElement("div", { ...getStyles("header") }, /* @__PURE__ */ React.createElement(ScrollArea, { type: "never", dir: "ltr", offsetScrollbars: false }, /* @__PURE__ */ React.createElement("div", { ...getStyles("files") }, files)), /* @__PURE__ */ React.createElement("div", { ...getStyles("controls") }, withExpandButton && /* @__PURE__ */ React.createElement(
    Tooltip,
    {
  ...
  ))))), /* @__PURE__ */ React.createElement(ScrollArea, { type: "auto", dir: "ltr", offsetScrollbars: false }, /* @__PURE__ */ React.createElement(Box, { ...getStyles("codeWrapper"), mod: { expanded: _expanded } }, /* @__PURE__ */ React.createElement("pre", { ...getStyles("pre") }, /* @__PURE__ */ React.createElement("code", { ...getStyles("code"), dangerouslySetInnerHTML: { __html: highlighted } })))), /* @__PURE__ */ React.createElement(
    UnstyledButton,
    {

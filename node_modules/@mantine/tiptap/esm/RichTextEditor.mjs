...
const RichTextEditor = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(Box, { ...getStyles("root"), ...others, ref }, children)
  );
});

...
const StrikeThroughControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconStrikethrough, { ...props }),
...
const OrderedListControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconListNumbers, { ...props }),
...
const H1Control = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconH1, { ...props }),
...
const H2Control = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconH2, { ...props }),
  isActive: { name: "heading", attributes: { level: 2 } },
  operation: { name: "toggleHeading", attributes: { level: 2 } }
});
const H3Control = RichTextEditorControl.createControl({
  label: "h3ControlLabel",
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconH3, { ...props }),
...
const H4Control = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconH4, { ...props }),
...
const H5Control = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconH5, { ...props }),
...
const H6Control = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconH6, { ...props }),
...
const BlockquoteControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconBlockquote, { ...props }),
...
const AlignLeftControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconAlignLeft, { ...props }),
...
const AlignRightControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconAlignRight, { ...props }),
...
const AlignCenterControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconAlignCenter, { ...props }),
...
const AlignJustifyControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconAlignJustified, { ...props }),
...
const SubscriptControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconSubscript, { ...props }),
...
const SuperscriptControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconSuperscript, { ...props }),
...
const CodeControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconCode, { ...props }),
  isActive: { name: "code" },
...
const HighlightControl = RichTextEditorControl.createControl({
  ...
  icon: (props) => /* @__PURE__ */ React.createElement(Icons.IconHighlight, { ...props }),

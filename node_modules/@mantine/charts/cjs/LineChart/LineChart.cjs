...
const LineChart = core.factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement(recharts.ResponsiveContainer, { ...getStyles("container") }, /* @__PURE__ */ React.createElement(recharts.LineChart, { data, layout: orientation, ...lineChartProps }, withLegend && /* @__PURE__ */ React.createElement(
      recharts.Legend,
      {
        verticalAlign: "top",

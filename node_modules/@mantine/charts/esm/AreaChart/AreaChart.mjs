...
import { Area, ReferenceLine, ResponsiveContainer, AreaChart as AreaChart$1, Legend, CartesianGrid, XAxis, YAxis, Tooltip } from 'recharts';
    ...
    /* @__PURE__ */ React.createElement(ResponsiveContainer, { ...getStyles("container") }, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(
        YAxis,
        {
          ...
          allowDecimals: true,
          unit,
          tickFormatter: type === "percent" ? valueToPercent : void 0,
          ...getStyles("axis"),
          ...yAxisProps
        }
      ),

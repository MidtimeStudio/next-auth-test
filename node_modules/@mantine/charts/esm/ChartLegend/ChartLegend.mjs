...
const ChartLegend = factory((_props, ref) => {
  ...
  return /* @__PURE__ */ React.createElement(Box, { ref, mod: { position: legendPosition }, ...getStyles("legend"), ...others }, items);
});
